...
public interface RoadmapRepository extends JpaRepository<Roadmap, Long> {
    ...
    Page<Roadmap> findByOwnerIdOrderByTitleAsc(Long userId, Pageable pageable);

    Page<Roadmap> findByVisibilityAndStatus(RoadmapVisibility visibility, ModerationStatus status, Pageable pageable);
    ...
    Page<Roadmap> findFavoritedByUserId(@Param("userId") Long userId, Pageable pageable);
